        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li class="active"><a href="<?php echo base_url() ?>kategorimaterial/editkategori"><?php echo $title3 ?></a></li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo base_url() ?>kategorimaterial/updatekategori" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="id_katmet" value="<?php echo $id_katmet ?>">
                            <div class="form-group">
                                <label for="kategori_mat"><h6>Kategori Material</h6></label>
                                <input type="text" id="kategori_mat" name="kategori_mat" placeholder="Kategori Material" class="form-control" value="<?php echo $kategori_mat ?>" required>
                            </div>
                            <div class="form-group">
