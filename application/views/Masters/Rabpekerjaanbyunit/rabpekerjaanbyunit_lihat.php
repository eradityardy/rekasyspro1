        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li><a href="<?php echo base_url() ?>rabpekerjaanbyunit"><?php echo $title2 ?></a></li>
                    <li class="active"><a href="<?php echo base_url() ?>rabpekerjaanbyunit/lihatrabpekerjaanbyunit"><?php echo $title3 ?></a></li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url('index.php/rabpekerjaanbyunit/hapusrabpekerjaanbyunit/'.$k['id']) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda benar-benar akan menghapus Data?')">
                        ...
                        <div class="box-tools pull-right">
                            <a href="<?php echo base_url('index.php/rabpekerjaanbyunit/') ?>" class="btn btn-warning">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="modal_add_pekerjaan" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    ...
    <form class="form-horizontal" method="post" action="<?php echo base_url() ?>index.php/rabpekerjaanbyunit/simpanrabpekerjaanbyunit">
        ...
        <div class="modal-footer">
            <input type="submit" name="simpanrabpekerjaanbyunit" class="btn btn-primary" value="Simpan">
