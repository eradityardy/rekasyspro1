                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo base_url('dataproyek/hapusproyek/'.$row->id_pro) ?>" class="btn btn-danger btn-sm delete-record" data-id="<?php echo $row->id_pro;?>" onclick="return confirm('Apakah anda benar-benar akan menghapus Data?')"><i class="fa fa-trash"></i> Hapus</a>
                                    </td>
                                </tr>
                                <?php endforeach;?>
                            </tbody>
