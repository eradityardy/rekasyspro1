        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li class="active"><a href="<?php echo base_url() ?>datapekerja/tambahpekerja"><?php echo $title3 ?></a></li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo base_url() ?>datapekerja/simpanpekerja" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="row form-group">
                                <div class="col col-md-6">
                                    <label for="nama_pek"><h6>Nama</h6></label>
                                    <input type="text" id="nama_pek" name="nama_pek" placeholder="Nama" class="form-control" required>
                                </div>
                                <div class="col col-md-6">
