        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li class="active"><a href="<?php echo base_url() ?>kategoripekerjaan/tambahkategori"><?php echo $title3 ?></a></li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo base_url() ?>kategoripekerjaan/simpankategori" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="kategori_pek"><h6>Kategori Pekerjaan</h6></label>
                                <input type="text" id="kategori_pek" name="kategori_pek" placeholder="Kategori Pekerjaan" class="form-control" required>
                            </div>
                            <div class="form-group">
