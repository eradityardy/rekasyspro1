                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo base_url('kategoripekerjaan/hapuskategori/'.$row->id_katpek) ?>" class="btn btn-danger btn-sm delete-record" data-id="<?php echo $row->id_katpek;?>" onclick="return confirm('Apakah anda benar-benar akan menghapus Data?')"><i class="fa fa-trash"></i> Hapus</a>
                                    </td>
                                </tr>
                                <?php endforeach;?>
                            </tbody>
