        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li class="active"><a href="<?php echo base_url() ?>datasupplier/editsupplier"><?php echo $title3 ?></a></li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo base_url() ?>datasupplier/updatesupplier" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="row form-group">
                                <input type="hidden" name="id" value="<?php echo $id ?>">
                                <div class="col col-md-6">
                                    <label for="nama"><h6>Supplier</h6></label>
                                    <input type="text" id="nama" name="nama" placeholder="Supplier" class="form-control" value="<?php echo $nama ?>" required>
                                </div>
                                <div class="col col-md-6">
                            ...
                            <div class="row form-group">
                                <div class="col col-md-6">
                                    <input type="submit" name="updatesupplier" class="btn btn-primary" value="Update">
                                </div>
                                <div class="col col-md-6">
