                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a class="btn btn-sm btn-warning" href="<?php echo base_url ('opnameprogress/OpnameProgressPDF') ?>">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url('opnameprogress/editprogress/'.$k['id_op']) ?>" class="btn btn-sm btn-info">
                                        <i class="fa fa-edit"></i> Edit
                                        </a>
                                        <a href="<?php echo base_url('opnameprogress/hapusprogress/'.$k['id_op']) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda benar-benar akan menghapus Data?')">
