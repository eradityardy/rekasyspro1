                        ...
                        <form action="<?php echo base_url() ?>opnameprogress/updateprogress" method="post" class="form-horizontal">
                            <div class="row form-group">
                                ...
                                <div class="col col-md-6">
                                    ...
                                    <select name="unit_id1" id="unit_id1" class="form-control" required>
                                        ...
                                        {
                                            if ($row->id == $unit_id){
                                                printf("<option value='%s|%s|%s|%s|%s' selected='selected'>%s - %s</option>",$row->id,$row->unit_id,$row->pekerjaan_id,$row->pekerjaan,$row->price,$row->alamat,$row->pekerjaan);
                                            }else {
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <input type="text" id="pekerjaan_id1" name="pekerjaan_id1" class="form-control" value="" Readonly>
...
<script type="text/javascript">
    $(function(){
        ...
        $('#qty').keyup(function(){
            ...
            var tersedia1 = parseInt($('#tersedia').val());

            var sisamat=tersedia1-qty1;
            $('#sisa_mat').val(sisamat);
        });
    });
</script>