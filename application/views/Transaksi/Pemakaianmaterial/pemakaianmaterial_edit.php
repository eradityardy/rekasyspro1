        ...
        <div class="page-header float-right">
            <div class="page-title">
                <ol class="breadcrumb text-right">
                    ...
                    <li class="active"><a href="<?php echo base_url() ?>pemakaianmaterial/editpemakaian"><?php echo $title3 ?></a></li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo base_url() ?>pemakaianmaterial/updatepemakaian" method="post" class="form-horizontal">
                            <div class="row form-group">
                                ...
                                <div class="col col-md-6">
                                    ...
                                    <select name="unit_id1" id="unit_id1" class="form-control" required>
                                        ...
                                        {
                                            if ($row->id_rmbu == $unit_id1){
                                                printf("<option value='%s|%s|%s|%s|%s|%s' selected='selected'>%s - %s</option>",$row->id_rmbu,$row->unit_id,$row->material_id,$row->nama_brg,$row->price,$row->qty,$row->alamat,$row->nama_brg);
                                            }else {
                            ...
                            <div class="row form-group">
                                ...
                                <label for="stock_id1"><h6>Stock Material</h6></label>
                                    <select name="stock_id1" id="stock_id1" class="form-control" required>
                                        ...
                                        {  
                                            if ($row->id_stomat == $stock_id1){
                                                printf("<option value='%s|%s' selected='selected'>%s - %s - %s</option>",$row->id_stomat,$row->qty_stock,$row->nama_gud,$row->nama_brg,$row->nama);
                                            }else {
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <input type="text" id="material_id1" name="material_id" class="form-control" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="float-left">
                                    <input type="submit" name="updatepemakaian" class="btn btn-primary" value="Update">
                                </div>
                            </div>
                        </form>
                    </div>
